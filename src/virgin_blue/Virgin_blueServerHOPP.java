...
public class Virgin_blueServerHOPP {
	...
	public synchronized ArrayList<String> BookTicket(String str )
	{
		...
		ArrayList<String> ticketList = new ArrayList<String>( 
				query.bookTicket( Departure, Arrive, "Virgin_blue", DepartDate, ReturnDate, username, phone, email, creditno) );
		return ticketList;
	}
	...
	public ArrayList<String> QueryVacantSeat( String str )
	{
		...
		//DAOImpl query = new DAOImpl();
		ArrayList<String> seatList = new ArrayList<String>( query.queryTicketNum(Departure, Arrive, "Virgin_blue", DepartDate) );
		return seatList;
	}
	...
	public ArrayList<String> QueryPrice( String str )
	{
		...
		ArrayList<String> priceList = new ArrayList<String>( query.queryFlightRate( Departure, Arrive, "Virgin_blue") );
		return priceList;
	}
	...
	public ArrayList<String> QueryAirline( String str )
	{
		...
		ArrayList<String> airlineList = new ArrayList<String>( query.queryAirline(Departure, Arrive, "Virgin_blue") );
		return airlineList;
	}
	...
	{
		//DAOImpl query = new DAOImpl();
		ArrayList<String> cityList = new ArrayList<String>( query.queryCity("Virgin_blue") );
		return cityList;
	}
